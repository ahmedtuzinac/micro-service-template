...
DEFAULT_DATABASE_URL = f"postgres://{POSTGRES_USER}:{POSTGRES_PASSWORD}@{POSTGRES_HOST}:{POSTGRES_PORT}/order_db"
...
# Dodavanje router-a
app_instance.add_router(router, prefix="/api/v1", tags=["order-service"])
